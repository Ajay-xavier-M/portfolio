...
function Contact() {
  const [state, handleSubmit] = useForm("xvgzdbqp");
  if (state.succeeded){
      setTimeout(() => {
  ...
  return (
    <div className='section-container'>
      ...
      <div className='social-icons-container'>
        <a href="https://github.com/Ajay-xavier-M"
          className='social-icon'
          target="_blank" rel="noreferrer">
          <img src={gitHub} alt='github' loading="lazy"/>
        </a>
        <a href="http://www.linkedin.com/in/ajay-xavier-m-1337a4315"
          className='social-icon'
          target="_blank" rel="noreferrer">
          <img src={linkedIn} alt='linkedin' loading="lazy"/>
        </a>
        <a href="https://medium.com/@ajay82811inv"
          className='social-icon'
          target="_blank" rel="noreferrer">
          <img src={medium} alt='medium' loading="lazy"/>
        </a>
        <a href="https://www.instagram.com/_ajay_xavier/"
          className='social-icon'
          target="_blank" rel="noreferrer">
